...
#if USE_IBV==1
static const int UseIbv = 1; // use IB Verbs if set to 1. use RPC by default.
#define ibvCuda(x) cuda ## x
#define rpcCuda(x) rpcCuda ## x
#else
static const int UseIbv = 0; // use IB Verbs if set to 1. use RPC by default.
#define ibvCuda(x) ibvCuda ## x
#define rpcCuda(x) cuda ## x
#endif
...
cudaError_t
ibvCuda(GetLastError)(void)
{
    WARN(3, "a dummy call to cudaGetLastError()\n");
    return cudaSuccess;
}

cudaError_t
rpcCuda(GetLastError)(void)
{
    cudaError_t err = cudaSuccess;
    dscudaResult *rp;
...
const char *
ibvCuda(GetErrorString)(cudaError_t error)
{
    static char str[256];
...
const char *
rpcCuda(GetErrorString)(cudaError_t error)
{
...
cudaError_t
ibvCuda(RuntimeGetVersion)(int *runtimeVersion)
{
    cudaError_t err = cudaSuccess;
...
cudaError_t
rpcCuda(RuntimeGetVersion)(int *runtimeVersion)
{
    cudaError_t err = cudaSuccess;
...
cudaError_t
ibvCuda(DeviceSynchronize)(void)
{
    cudaError_t err = cudaSuccess;
...
cudaError_t
rpcCuda(DeviceSynchronize)(void)
{
    cudaError_t err = cudaSuccess;
    dscudaResult *rp;
 ...
 */
cudaError_t
ibvCuda(Malloc)(void **devAdrPtr, size_t size)
{
    cudaError_t err = cudaSuccess;
    void *devadr;
...
cudaError_t
rpcCuda(Malloc)(void **devAdrPtr, size_t size)
{
    cudaError_t err = cudaSuccess;
...
cudaError_t
ibvCuda(Memcpy)(void *dst, const void *src, size_t count, enum cudaMemcpyKind kind)
{
    cudaError_t err = cudaSuccess;
    Vdev_t *vdev;
...
cudaError_t
rpcCuda(Memcpy)(void *dst, const void *src, size_t count, enum cudaMemcpyKind kind)
{
    cudaError_t err = cudaSuccess;
...
cudaError_t
ibvCuda(GetDeviceProperties)(struct cudaDeviceProp *prop, int device)
{
    cudaError_t err = cudaSuccess;
...
cudaError_t
rpcCuda(GetDeviceProperties)(struct cudaDeviceProp *prop, int device)
{
    cudaError_t err = cudaSuccess;
...
cudaError_t
ibvCuda(EventCreate)(cudaEvent_t *event)
{
...
cudaError_t
rpcCuda(EventCreate)(cudaEvent_t *event)
{
    cudaError_t err = cudaSuccess;
...
cudaError_t
ibvCuda(EventCreateWithFlags)(cudaEvent_t *event, unsigned int flags)
{
    static cudaEvent_t e;
    *event = e;
...
cudaError_t
rpcCuda(EventCreateWithFlags)(cudaEvent_t *event, unsigned int flags)
{
    cudaError_t err = cudaSuccess;
    dscudaEventCreateResult *rp;
    cudaEvent_t ev[RC_NREDUNDANCYMAX];
...
cudaError_t
ibvCuda(EventDestroy)(cudaEvent_t event)
{
...
cudaError_t
rpcCuda(EventDestroy)(cudaEvent_t event)
{
    cudaError_t err = cudaSuccess;
    dscudaResult *rp;
    RCeventArray *ev;
...
cudaError_t
ibvCuda(EventElapsedTime)(float *ms, cudaEvent_t start, cudaEvent_t end)
{
    *ms = 123.0;
...
cudaError_t
rpcCuda(EventElapsedTime)(float *ms, cudaEvent_t start, cudaEvent_t end)
{
    cudaError_t err = cudaSuccess;
...
cudaError_t
ibvCuda(EventRecord)(cudaEvent_t event, cudaStream_t stream)
{
...
cudaError_t
rpcCuda(EventRecord)(cudaEvent_t event, cudaStream_t stream)
{
    cudaError_t err = cudaSuccess;
    dscudaResult *rp;
    RCstreamArray *st;
...
cudaError_t
ibvCuda(EventSynchronize)(cudaEvent_t event)
{
...
cudaError_t
rpcCuda(EventSynchronize)(cudaEvent_t event)
{
    cudaError_t err = cudaSuccess;
    dscudaResult *rp;
    RCeventArray *ev;
...
cudaError_t
ibvCuda(EventQuery)(cudaEvent_t event)
{
...
cudaError_t
rpcCuda(EventQuery)(cudaEvent_t event)
{
    cudaError_t err = cudaSuccess;
    dscudaResult *rp;
    RCeventArray *ev;
