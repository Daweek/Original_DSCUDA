...
{
  WARN(2, "add hist IbvLaunchKernel\n");
...
{
  WARN(2, "add hist cudaConfigureCall\n");
...
{
  WARN(2, "add hist cudaSetupArgument\n");
...
{
  WARN(2, "add hist cudaSetupArgumentOfTypeP\n");
...
{
  WARN(2, "add hist dscudaLaunchWrapper\n");
...
recallConfigureCall(void *argp) {
  DSCUDAVERB_SET_ARGS(ConfigureCall);
  WARN(2, "recall cudaConfigureCall\n");
  dim3 gdim, bdim;
...
recallSetupArgument(void *argp) {
  DSCUDAVERB_SET_ARGS(SetupArgument);
  WARN(2, "recall cudaSetupArgument\n");
...
recallSetupArgumentOfTypeP(void *argp) {
  DSCUDAVERB_SET_ARGS(SetupArgumentOfTypeP);
  WARN(2, "recall dscudaSetupArgumentOfTypeP\n");
...
recallDscudaLaunchWrapper(void *argp) {
  DSCUDAVERB_SET_ARGS(DscudaLaunchWrapper);
  WARN(2, "recall dscudaLaunchWrapper\n");
...
void dscudaVerbClearHist(void) {
  ...
  WARN(2, "function history cleared\n");
  return;
}
